  ...
  <div class="">
     <section class="banner">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3">
              <div class="col-span-2 ">
                <div class="flex items-center banner__caption">
                  <div>
                    <h1 class="title__principal mb-5">¡Explota todo tu potencial tecnológico!</h1>
                    <h4 class="title__secundary">Con nuestros programas de especialización</h4>
                  </div>
                </div>
              </div>
              <div class="banner__img">
                <form>
                  <h2 class="subtitle__basic my-4">Postula y obtén un 10% de descuento en el programa</h2>
                  <input type="text" placeholder="Nombre">
                  <input type="text" placeholder="Tefefono">
                  <input type="email" placeholder="Correo Electronico">
                  <input type="Text" placeholder="Programa" class="mb-3">
                  <div class="mb-5">
                    <input type="checkbox" name="" id=""> <label for="" class="text__small">Acepto las Políticas de privacidad.</label>
                  </div>
      ...
      <section class="py-20 fondo-color">
        <div class="container mx-auto px-4 md:px-0">
            <h3 class="subtitle__principal mb-7">Conoce nuestros Programas de Especialización</h3>
      ...
      <section class="pannel ">
        <img src="../assets/images/Chinita_pacha.png" alt="">
         <div class="container mx-auto px-4 md:px-0">
           <div class="grid md:grid-cols-2 lg:grid-cols-3">
              <div class="col-span-2 md:flex ">
                <div class="pannel__caption">
                  <h3 class="subtitle__principal mb-3">Sé parte de la comunidad</h3>
                  <p class="mb-3">Programas semi-presenciales para el desarrollo de habilidades de programación a lo largo de todo el Stack tecnológico.</p>
                  <p>Al finalizar sabrás cómo crear una página web y desarrollar la lógica detrás del funcionamiento de una aplicación, así como formar parte de una gran comunidad de desarrolladores.</p>
                </div>
              </div>
            </div>
         </div>
